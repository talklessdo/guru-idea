...
class BukuKerjaFactory extends Factory
{
    ...
    {
        $guruId = 2;
        // $guruId = Arr::random(array_diff(range(1, 14), [1, 8, 11]));
        $indikatorId = rand(28, 29);
        ...
        return [
            ...
            'tp' => $this->faker->randomElement(['2024/2025', '2025/2026', '2026/2027']),
            ...
            'status' => $this->faker->randomElement(['approve', 'pending']),
...
// App\Models\BukuKerja::factory()->count(50)->create();
