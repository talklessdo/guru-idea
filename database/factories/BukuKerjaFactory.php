...
class BukuKerjaFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        // if ($kategoriKode == 1) {
        //     $kategori = 'bk1';
        // } elseif ($kategoriKode == 2) {
        //     $kategori = 'bk2';
        // } elseif ($kategoriKode == 3) {
        //     $kategori = 'bk3';
        // } elseif ($kategoriKode == 4) {
        //     $kategori = 'bk4';
        // } else {
        //     $kategori = 'n/a';
        // }
        return [
            ...
            'tp' => $this->faker->randomElement(['2024/2025', '2025/2026']),
...
// App\Models\BukuKerja::factory()->count(15)->create();
