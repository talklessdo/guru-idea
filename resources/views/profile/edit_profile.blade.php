      ...
      <form action="/update-profile" method="POST">
        ...
        <div class="details-grid">
            ...
            <div class="detail-item">
                ...
                <input disabled type="text" inputmode="numeric" pattern="[0-9]*"  oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="total_jtm" class="detail-value" value="{{ old('total_jtm', $dataGuru->total_jtm) }}">
                @error('total_jtm')
                    <span style="color: red" class="text-sm">{{ $message }}</span>
                @enderror
            </div>
