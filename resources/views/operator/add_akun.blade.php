            ...
            <form id="formRegister" action="/store_akun" method="post">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputName" placeholder="Masukkan Nama">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail1" placeholder="Masukkan Email">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <select name="role" class="form-control @error('role') is-invalid @enderror" id="exampleInputRole">
